...
#define configUSE_PORT_OPTIMISED_TASK_SELECTION 1   //0
#endif
...
#define configTIMER_TASK_PRIORITY (15)          //2 volt
#endif

#define configTIMER_QUEUE_LENGTH 16              //2 volt
...
#define configUSE_QUEUE_SETS 0                  //<--amikor itt 1 volt, akkor nem fordult le a systemview
...
function. */
//#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY 0x07    //0x07
...
//Ha ez modosul, akkor a SEGGER_RTT-ben a SEGGER_RTT_MAX_INTERRUPT_PRIORITY
//makrot utana kell huzni! configMAX_SYSCALL_INTERRUPT_PRIORITY-ertekkel azonos
//erteknek kell szerepelnie.
...
//A szoftverben hasznaljuk a Task Notify lehetosegeket!
//(Ez alapertelmezesben be van allitva a FreeRTOS.h-ban is)
